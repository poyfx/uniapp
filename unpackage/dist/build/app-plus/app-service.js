...
var xIB=_mz(z,'info-text',['bind:__l',2,'placeholder',1,'textValue',2,'vueId',3],[],e,s,gg)
_(oHB,xIB)
var oJB=_mz(z,'info-text',['bind:__l',6,'placeholder',1,'textValue',2,'vueId',3],[],e,s,gg)
_(oHB,oJB)
var fKB=_mz(z,'info-text',['bind:__l',10,'placeholder',1,'textValue',2,'vueId',3],[],e,s,gg)
_(oHB,fKB)
_(bGB,oHB)
var cLB=_mz(z,'m-button',['bind:__l',14,'type',1,'value',2,'vueId',3],[],e,s,gg)
_(bGB,cLB)
_(r,bGB)
return r
}
...
var oPB=_mz(z,'info-text',['bind:__l',2,'disabled',1,'textValue',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(cOB,oPB)
var lQB=_mz(z,'info-text',['bind:__l',8,'disabled',1,'textValue',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(cOB,lQB)
var aRB=_mz(z,'info-text',['bind:__l',14,'disabled',1,'textValue',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(cOB,aRB)
var tSB=_mz(z,'info-text',['bind:__l',20,'disabled',1,'textValue',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(cOB,tSB)
_(oNB,cOB)
var eTB=_n('view')
_rz(z,eTB,'class',26,e,s,gg)
var bUB=_mz(z,'info-img',['bind:__l',27,'bind:toApply',1,'data-event-opts',2,'disabled',3,'imgText',4,'type',5,'vueId',6],[],e,s,gg)
_(eTB,bUB)
var oVB=_mz(z,'info-img',['bind:__l',34,'bind:toStayOil',1,'data-event-opts',2,'disabled',3,'imgText',4,'type',5,'vueId',6],[],e,s,gg)
_(eTB,oVB)
var xWB=_mz(z,'info-img',['bind:__l',41,'bind:editAddress',1,'data-event-opts',2,'disabled',3,'imgText',4,'type',5,'vueId',6],[],e,s,gg)
_(eTB,xWB)
var oXB=_mz(z,'info-img',['bind:__l',48,'bind:toEditPsd',1,'data-event-opts',2,'disabled',3,'imgText',4,'type',5,'vueId',6],[],e,s,gg)
_(eTB,oXB)
_(oNB,eTB)
_(r,oNB)
return r
...
_(h1B,c3B)
var o4B=_mz(z,'set-password',['bind:__l',16,'bind:input',1,'data-event-opts',2,'placeholder',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(h1B,o4B)
_(cZB,h1B)
var l5B=_mz(z,'m-button',['bind:__l',23,'bind:sureModify',1,'class',2,'data-event-opts',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(cZB,l5B)
_(r,cZB)
return r
}
...
var z=gz$gwx_26()
var b9B=_mz(z,'m-button',['bind:__l',0,'bind:goNext',1,'data-event-opts',1,'type',2,'value',3,'vueId',4],[],e,s,gg)
_(r,b9B)
return r
}
...
var oBC=_mz(z,'m-input',['bind:__l',1,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'value',5,'vueId',6],[],e,s,gg)
_(xAC,oBC)
var fCC=_mz(z,'pws-input',['bind:__l',8,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'value',5,'vueId',6],[],e,s,gg)
_(xAC,fCC)
var cDC=_mz(z,'m-button',['bind:__l',15,'bind:handleLogin',1,'class',2,'data-event-opts',3,'disabled',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(xAC,cDC)
_(r,xAC)
return r
}
...
var oHC=_mz(z,'set-password',['bind:__l',2,'bind:input',1,'data-event-opts',2,'placeholder',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(cGC,oHC)
var lIC=_mz(z,'set-password',['bind:__l',9,'bind:input',1,'data-event-opts',2,'placeholder',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(cGC,lIC)
_(oFC,cGC)
var aJC=_mz(z,'m-button',['bind:__l',16,'bind:sureModify',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(oFC,aJC)
_(r,oFC)
return r
}
...
var oNC=_mz(z,'info-text',['bind:__l',1,'bind:input',1,'data-event-opts',2,'placeholder',3,'textValue',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(bMC,oNC)
var xOC=_mz(z,'m-button',['bind:__l',9,'bind:toBuy',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(bMC,xOC)
_(r,bMC)
return r
}
...
var hSC=_mz(z,'info-text',['bind:__l',2,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(cRC,hSC)
var oTC=_mz(z,'info-text',['bind:__l',9,'bind:input',1,'data-event-opts',2,'textValue',3,'value',4,'vueId',5],[],e,s,gg)
_(cRC,oTC)
_(fQC,cRC)
var cUC=_mz(z,'view',['class',15,'hidden',1,'style',2],[],e,s,gg)
var oVC=_mz(z,'info-text',['bind:__l',18,'disabled',1,'textValue',2,'value',3,'vueId',4],[],e,s,gg)
_(cUC,oVC)
var lWC=_mz(z,'info-text',['bind:__l',23,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(cUC,lWC)
_(fQC,cUC)
var aXC=_mz(z,'t-button',['bind:__l',30,'bind:invoiceSure',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(fQC,aXC)
_(r,fQC)
return r
}
...
var eDD=_mz(z,'t-button',['bind:__l',12,'bind:sureBuy',1,'class',2,'content',3,'data-event-opts',4,'type',5,'vueId',6],[],e,s,gg)
_(o2C,eDD)
}
else{o2C.wxVkey=2
var bED=_v()
...
var oFD=_mz(z,'m-button',['bind:__l',20,'bind:tell',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(bED,oFD)
}
else{bED.wxVkey=2
var xGD=_v()
...
var oHD=_mz(z,'t-button',['bind:__l',27,'bind:tell',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(xGD,oHD)
}
else{xGD.wxVkey=2
var fID=_v()
...
var cJD=_mz(z,'m-button',['bind:__l',36,'bind:tell',1,'data-event-opts',2,'disabled',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(fID,cJD)
}
fID.wxXCkey=1
fID.wxXCkey=3
...
var z=gz$gwx_33()
var oLD=_n('view')
var cMD=_mz(z,'selects',['bind:__l',0,'bind:change',1,'clearable',1,'data-event-opts',2,'initValue',3,'isCanInput',4,'list',5,'listShow',6,'placeholder',7,'showItemNum',8,'style_Container',9,'vueId',10],[],e,s,gg)
_(oLD,cMD)
var oND=_v()
_(oLD,oND)
var lOD=function(tQD,aPD,eRD,gg){
var oTD=_mz(z,'view',['bindtap',16,'class',1,'data-event-opts',2],[],tQD,aPD,gg)
var xUD=_v()
_(oTD,xUD)
if(_oz(z,19,tQD,aPD,gg)){xUD.wxVkey=1
}
else{xUD.wxVkey=2
var c1D=_v()
_(xUD,c1D)
if(_oz(z,20,tQD,aPD,gg)){c1D.wxVkey=1
}
else{c1D.wxVkey=2
var o2D=_v()
_(c1D,o2D)
if(_oz(z,21,tQD,aPD,gg)){o2D.wxVkey=1
}
o2D.wxXCkey=1
}
c1D.wxXCkey=1
...
var oVD=_v()
_(oTD,oVD)
if(_oz(z,22,tQD,aPD,gg)){oVD.wxVkey=1
}
var fWD=_v()
_(oTD,fWD)
if(_oz(z,23,tQD,aPD,gg)){fWD.wxVkey=1
}
var cXD=_v()
_(oTD,cXD)
if(_oz(z,24,tQD,aPD,gg)){cXD.wxVkey=1
}
var hYD=_v()
_(oTD,hYD)
if(_oz(z,25,tQD,aPD,gg)){hYD.wxVkey=1
}
var oZD=_v()
_(oTD,oZD)
if(_oz(z,26,tQD,aPD,gg)){oZD.wxVkey=1
}
xUD.wxXCkey=1
oVD.wxXCkey=1
fWD.wxXCkey=1
...
oND.wxXCkey=2
_2z(z,14,lOD,e,s,gg,oND,'item','__i0__','id')
_(r,oLD)
return r
}
...
var e6D=_mz(z,'step',['actives',2,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(t5D,e6D)
var b7D=_mz(z,'step',['actives',8,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(t5D,b7D)
var o8D=_mz(z,'step',['actives',14,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(t5D,o8D)
var x9D=_mz(z,'step',['actives',20,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(t5D,x9D)
_(a4D,t5D)
var o0D=_n('view')
_rz(z,o0D,'class',26,e,s,gg)
var fAE=_mz(z,'w-picker',['bind:__l',27,'bind:confirm',1,'class',2,'current',3,'data-event-opts',4,'data-ref',5,'defaultVal',6,'endYear',7,'mode',8,'startYear',9,'themeColor',10,'vueId',11],[],e,s,gg)
_(o0D,fAE)
var cBE=_mz(z,'w-picker',['bind:__l',39,'bind:confirm',1,'class',2,'current',3,'data-event-opts',4,'data-ref',5,'defaultVal',6,'endYear',7,'mode',8,'startYear',9,'themeColor',10,'vueId',11],[],e,s,gg)
_(o0D,cBE)
_(a4D,o0D)
var hCE=_mz(z,'m-button',['bind:__l',51,'bind:oneSide',1,'class',2,'data-event-opts',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(a4D,hCE)
var oDE=_mz(z,'view',['class',58,'hidden',1],[],e,s,gg)
var cEE=_mz(z,'t-button',['bind:__l',60,'bind:lastStep',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(oDE,cEE)
var oFE=_mz(z,'t-button',['bind:__l',68,'bind:nextStep',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(oDE,oFE)
_(a4D,oDE)
var lGE=_mz(z,'view',['class',76,'hidden',1],[],e,s,gg)
var aHE=_mz(z,'t-button',['bind:__l',78,'bind:threeStepLast',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(lGE,aHE)
var tIE=_mz(z,'t-button',['bind:__l',86,'bind:threeStepNext',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(lGE,tIE)
_(a4D,lGE)
var eJE=_mz(z,'view',['class',94,'hidden',1],[],e,s,gg)
var bKE=_mz(z,'t-button',['bind:__l',96,'bind:fourStepLast',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(eJE,bKE)
var oLE=_mz(z,'t-button',['bind:__l',104,'bind:fourStepNext',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(eJE,oLE)
_(a4D,eJE)
_(r,a4D)
return r
...
var cPE=_mz(z,'step',['actives',2,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(fOE,cPE)
var hQE=_mz(z,'step',['actives',8,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(fOE,hQE)
var oRE=_mz(z,'step',['actives',14,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(fOE,oRE)
_(oNE,fOE)
var cSE=_mz(z,'form',['bindreset',20,'data-event-opts',1,'enctype',2],[],e,s,gg)
var oTE=_mz(z,'w-picker',['bind:__l',23,'bind:confirm',1,'class',2,'current',3,'data-event-opts',4,'data-ref',5,'defaultVal',6,'endYear',7,'mode',8,'startYear',9,'themeColor',10,'vueId',11],[],e,s,gg)
_(cSE,oTE)
_(oNE,cSE)
var lUE=_mz(z,'m-button',['bind:__l',35,'bind:oneSide',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(oNE,lUE)
var aVE=_mz(z,'view',['class',41,'hidden',1],[],e,s,gg)
var tWE=_mz(z,'t-button',['bind:__l',43,'bind:lastStep',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(aVE,tWE)
var eXE=_mz(z,'t-button',['bind:__l',51,'bind:nextStep',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(aVE,eXE)
_(oNE,aVE)
var bYE=_mz(z,'view',['class',59,'hidden',1],[],e,s,gg)
var oZE=_mz(z,'t-button',['bind:__l',61,'bind:threeStepLast',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(bYE,oZE)
var x1E=_mz(z,'t-button',['bind:__l',69,'bind:threeStepNext',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(bYE,x1E)
_(oNE,bYE)
_(r,oNE)
return r
...
var h5E=_mz(z,'step',['actives',2,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(c4E,h5E)
var o6E=_mz(z,'step',['actives',8,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(c4E,o6E)
var c7E=_mz(z,'step',['actives',14,'bind:__l',1,'class',2,'data-ref',3,'value',4,'vueId',5],[],e,s,gg)
_(c4E,c7E)
_(f3E,c4E)
var o8E=_mz(z,'w-picker',['bind:__l',20,'bind:confirm',1,'class',2,'current',3,'data-event-opts',4,'data-ref',5,'defaultVal',6,'endYear',7,'mode',8,'startYear',9,'themeColor',10,'vueId',11],[],e,s,gg)
_(f3E,o8E)
var l9E=_mz(z,'m-button',['bind:__l',32,'bind:oneSide',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(f3E,l9E)
var a0E=_mz(z,'view',['class',38,'hidden',1],[],e,s,gg)
var tAF=_mz(z,'t-button',['bind:__l',40,'bind:lastStep',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(a0E,tAF)
var eBF=_mz(z,'t-button',['bind:__l',48,'bind:nextStep',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(a0E,eBF)
_(f3E,a0E)
var bCF=_mz(z,'view',['class',56,'hidden',1],[],e,s,gg)
var oDF=_mz(z,'t-button',['bind:__l',58,'bind:threeStepLast',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(bCF,oDF)
var xEF=_mz(z,'t-button',['bind:__l',66,'bind:threeStepNext',1,'class',2,'content',3,'data-event-opts',4,'disabled',5,'type',6,'vueId',7],[],e,s,gg)
_(bCF,xEF)
_(f3E,bCF)
_(r,f3E)
return r
...
var hIF=_mz(z,'info-img',['bind:__l',2,'bind:chooseUser',1,'bind:input',2,'class',3,'data-event-opts',4,'disabled',5,'imgText',6,'placeholder',7,'value',8,'vueId',9],[],e,s,gg)
_(cHF,hIF)
var oJF=_mz(z,'info-img',['bind:__l',12,'bind:input',1,'bind:oilByCompany',2,'class',3,'data-event-opts',4,'disabled',5,'imgText',6,'placeholder',7,'value',8,'vueId',9],[],e,s,gg)
_(cHF,oJF)
var cKF=_mz(z,'info-text',['bind:__l',22,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'textValue',5,'value',6,'vueId',7],[],e,s,gg)
_(cHF,cKF)
var oLF=_mz(z,'info-text',['bind:__l',30,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'textValue',5,'value',6,'vueId',7],[],e,s,gg)
_(cHF,oLF)
var lMF=_mz(z,'info-text',['bind:__l',38,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'textValue',5,'value',6,'vueId',7],[],e,s,gg)
_(cHF,lMF)
var aNF=_mz(z,'info-text',['bind:__l',46,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'textValue',5,'value',6,'vueId',7],[],e,s,gg)
_(cHF,aNF)
var tOF=_mz(z,'info-img',['bind:__l',54,'bind:chooseCustomer',1,'bind:input',2,'class',3,'data-event-opts',4,'disabled',5,'imgText',6,'placeholder',7,'value',8,'vueId',9],[],e,s,gg)
_(cHF,tOF)
var ePF=_mz(z,'set-password',['bind:__l',64,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'textValue',5,'value',6,'vueId',7],[],e,s,gg)
_(cHF,ePF)
var bQF=_mz(z,'set-password',['bind:__l',72,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'textValue',5,'value',6,'vueId',7],[],e,s,gg)
_(cHF,bQF)
_(fGF,cHF)
var oRF=_mz(z,'m-button',['bind:__l',80,'bind:goPositive',1,'class',2,'data-event-opts',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(fGF,oRF)
_(r,fGF)
return r
}
...
var hWF=_mz(z,'info-img',['bind:__l',2,'bind:goOrderNumber',1,'data-event-opts',2,'disabled',3,'imgText',4,'placeholder',5,'value',6,'vueId',7],[],e,s,gg)
_(cVF,hWF)
var oXF=_mz(z,'rui-date-picker',['bind:__l',10,'bind:change',1,'class',2,'data-event-opts',3,'end',4,'fields',5,'start',6,'value',7,'vueId',8],[],e,s,gg)
_(cVF,oXF)
var cYF=_mz(z,'info-text',['bind:__l',19,'disabled',1,'placeholder',2,'textValue',3,'value',4,'vueId',5],[],e,s,gg)
_(cVF,cYF)
var oZF=_mz(z,'info-text',['bind:__l',25,'bind:input',1,'data-event-opts',2,'disabled',3,'placeholder',4,'textValue',5,'value',6,'vueId',7],[],e,s,gg)
_(cVF,oZF)
_(fUF,cVF)
var l1F=_mz(z,'m-button',['bind:__l',33,'bind:commit',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(fUF,l1F)
_(r,fUF)
return r
}
...
var o8F=_mz(z,'step',['actives',2,'bind:__l',1,'value',2,'vueId',3],[],e,s,gg)
_(x7F,o8F)
var f9F=_mz(z,'step',['actives',6,'bind:__l',1,'value',2,'vueId',3],[],e,s,gg)
_(x7F,f9F)
var c0F=_mz(z,'step',['actives',10,'bind:__l',1,'value',2,'vueId',3],[],e,s,gg)
_(x7F,c0F)
_(e4F,x7F)
}
var b5F=_v()
...
var hAG=_mz(z,'step',['actives',15,'bind:__l',1,'value',2,'vueId',3],[],e,s,gg)
_(b5F,hAG)
}
var o6F=_v()
_(t3F,o6F)
if(_oz(z,19,e,s,gg)){o6F.wxVkey=1
var oBG=_mz(z,'step',['actives',20,'bind:__l',1,'value',2,'vueId',3],[],e,s,gg)
_(o6F,oBG)
}
var cCG=_n('view')
...
var lEG=_mz(z,'info-text',['bind:__l',26,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(oDG,lEG)
var aFG=_mz(z,'info-text',['bind:__l',33,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(oDG,aFG)
var tGG=_mz(z,'info-text',['bind:__l',40,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(oDG,tGG)
var eHG=_mz(z,'info-text',['bind:__l',47,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(oDG,eHG)
var bIG=_mz(z,'info-text',['bind:__l',54,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(oDG,bIG)
var oJG=_mz(z,'info-text',['bind:__l',61,'bind:input',1,'data-event-opts',2,'disabled',3,'textValue',4,'value',5,'vueId',6],[],e,s,gg)
_(oDG,oJG)
_(cCG,oDG)
var xKG=_mz(z,'m-button',['bind:__l',68,'bind:close',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(cCG,xKG)
_(t3F,cCG)
e4F.wxXCkey=1
e4F.wxXCkey=3
...
var cNG=_mz(z,'tki-qrcode',['bind:__l',1,'bind:result',1,'cid',2,'class',3,'data-event-opts',4,'data-ref',5,'loadMake',6,'onval',7,'size',8,'usingComponents',9,'val',10,'vueId',11],[],e,s,gg)
_(fMG,cNG)
}
fMG.wxXCkey=1
fMG.wxXCkey=3
...
var cQG=_mz(z,'selects',['bind:__l',2,'bind:change',1,'clearable',2,'data-event-opts',3,'initValue',4,'isCanInput',5,'list',6,'listShow',7,'placeholder',8,'showItemNum',9,'style_Container',10,'vueId',11],[],e,s,gg)
_(oPG,cQG)
var oRG=_v()
_(oPG,oRG)
var lSG=function(tUG,aTG,eVG,gg){
var oXG=_mz(z,'view',['bindtap',18,'class',1,'data-event-opts',2],[],tUG,aTG,gg)
var xYG=_n('view')
_rz(z,xYG,'class',21,tUG,aTG,gg)
var oZG=_v()
_(xYG,oZG)
if(_oz(z,22,tUG,aTG,gg)){oZG.wxVkey=1
}
var f1G=_mz(z,'view',['class',23,'style',1],[],tUG,aTG,gg)
var c2G=_v()
_(f1G,c2G)
if(_oz(z,25,tUG,aTG,gg)){c2G.wxVkey=1
}
var h3G=_v()
_(f1G,h3G)
if(_oz(z,26,tUG,aTG,gg)){h3G.wxVkey=1
}
var o4G=_v()
_(f1G,o4G)
if(_oz(z,27,tUG,aTG,gg)){o4G.wxVkey=1
}
var c5G=_v()
_(f1G,c5G)
if(_oz(z,28,tUG,aTG,gg)){c5G.wxVkey=1
}
var o6G=_v()
_(f1G,o6G)
if(_oz(z,29,tUG,aTG,gg)){o6G.wxVkey=1
}
var l7G=_v()
_(f1G,l7G)
if(_oz(z,30,tUG,aTG,gg)){l7G.wxVkey=1
}
var a8G=_v()
_(f1G,a8G)
if(_oz(z,31,tUG,aTG,gg)){a8G.wxVkey=1
}
c2G.wxXCkey=1
h3G.wxXCkey=1
o4G.wxXCkey=1
...
oRG.wxXCkey=2
_2z(z,16,lSG,e,s,gg,oRG,'item','__i0__','reserve_id')
_(r,oPG)
return r
}
...
var z=gz$gwx_43()
var e0G=_mz(z,'m-button',['bind:__l',0,'bind:search',1,'class',1,'data-event-opts',2,'type',3,'value',4,'vueId',5],[],e,s,gg)
_(r,e0G)
return r
}
...
var z=gz$gwx_44()
var oBH=_mz(z,'selects',['bind:__l',0,'clearable',1,'initValue',1,'isCanInput',2,'list',3,'listShow',4,'placeholder',5,'showItemNum',6,'style_Container',7,'vueId',8],[],e,s,gg)
_(r,oBH)
return r
}
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{1831:function(e,t,n){},"5f90":function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=n("2f62");function r(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{},a=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(a=a.concat(Object.getOwnPropertySymbols(n).filter(function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable}))),a.forEach(function(t){o(e,t,n[t])})}return e}function o(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var i=function(){return n.e("components/banner/banner").then(n.bind(null,"0655"))},s=function(){return n.e("components/nav/nav").then(n.bind(null,"123d"))},c={data:function(){return{title:"",managerTel:"",myManager:"",datas:[],img:[],roles:this.role,address:"",city:"深圳",district:"龙华区",adcode:"",cityInfo:"",weather:"",dates:"",date:"",week:"",temperature:""}},onShow:function(){this.roles=this.role;var t=e.getStorageSync("Token");null!=t&&""!=t&&void 0!=t||e.showModal({title:"提示",content:"用户信息已失效，请重新登录",success:function(t){t.confirm,e.reLaunch({url:"../login/login"})}}),this.getlocation(),this.getAdcode(),this.getDate()},onLoad:function(){this.getInfo()},methods:{getInfo:function(){var t=this;e.getStorage({key:"userInfo",success:function(e){console.log(e," at pages\\index\\index.vue:254");var n=e.data.oilPrize;t.datas=n;var a=e.data.user;t.myManager=a.manager_name,t.managerTel=a.manager_phone;var r=e.data.banners;t.img=r}})},callPhone:function(t){e.showModal({title:"呼叫客户经理-"+this.myManager,confirmText:"呼叫",content:t,success:function(n){if(n.confirm)e.makePhoneCall({phoneNumber:t});else if(n.cancel)return}})},getlocation:function(){var t=this;e.getLocation({type:"wgs84",geocode:!0,success:function(e){e.longitude,e.latitude;t.address=e.address.city+e.address.district,t.city=e.address.city,t.district=e.address.district}})},getAdcode:function(){var t=this;e.request({url:"https://restapi.amap.com/v3/config/district?parameters",header:{"Content-Type":"application/json;charset=UTF-8"},data:{key:"b5066e0a9a2a996397e9172fc67fdf40",keywords:"深圳市",subdistrict:1},methods:"GET",success:function(e){if(e.data.districts.forEach(function(e){t.cityInfo=e}),200==e.statusCode&&1==e.data.status)for(var n=0;n<t.cityInfo.districts.length;n++)t.district==t.cityInfo.districts[n].name&&(t.adcode=t.cityInfo.districts[n].adcode);t.getWeather()}})},getWeather:function(){var t=this;e.request({url:"https://restapi.amap.com/v3/weather/weatherInfo?parameters",header:{"Content-Type":"application/json;charset=UTF-8"},data:{key:"b5066e0a9a2a996397e9172fc67fdf40",city:t.adcode,extensions:"base"},methods:"GET",success:function(e){e.data.lives.forEach(function(e){t.temperature=e.temperature,t.weather=e.weather})}})},getDate:function(){var e=new Date,t=e.getDay(),n=e.getMonth()+1,a=e.getFullYear(),r=e.getDate();switch(this.date=a+"-"+n+"-"+r,this.dates=n+"月"+r+"日",t){case 0:return this.week="星期天";case 1:return this.week="星期一";case 2:return this.week="星期二";case 3:return this.week="星期三";case 4:return this.week="星期四";case 5:return this.week="星期五";case 6:return this.week="星期六"}}},computed:r({},(0,a.mapState)(["hasLogin","userInfo","role"])),components:{banner:i,navs:s}};t.default=c}).call(this,n("6e42")["default"])},"678e":function(e,t,n){"use strict";n.r(t);var a=n("5f90"),r=n.n(a);for(var o in a)"default"!==o&&function(e){n.d(t,e,function(){return a[e]})}(o);t["default"]=r.a},"98dd":function(e,t,n){"use strict";var a=function(){var e=this,t=e.$createElement;e._self._c},r=[];n.d(t,"a",function(){return a}),n.d(t,"b",function(){return r})},a4fc:function(e,t,n){"use strict";n.r(t);var a=n("98dd"),r=n("678e");for(var o in r)"default"!==o&&function(e){n.d(t,e,function(){return r[e]})}(o);n("b040");var i=n("2877"),s=Object(i["a"])(r["default"],a["a"],a["b"],!1,null,null,null);t["default"]=s.exports},b040:function(e,t,n){"use strict";var a=n("1831"),r=n.n(a);r.a}},[["1fb7","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/register/positive/positive"],{1176:function(t,e,s){"use strict";var i=s("cd3b"),n=s.n(i);n.a},3767:function(t,e,s){"use strict";s.r(e);var i=s("b544"),n=s.n(i);for(var o in i)"default"!==o&&function(t){s.d(e,t,function(){return i[t]})}(o);e["default"]=n.a},a72e:function(t,e,s){"use strict";s.r(e);var i=s("a734"),n=s("3767");for(var o in n)"default"!==o&&function(t){s.d(e,t,function(){return n[t]})}(o);s("1176");var a=s("2877"),r=Object(a["a"])(n["default"],i["a"],i["b"],!1,null,null,null);e["default"]=r.exports},a734:function(t,e,s){"use strict";var i=function(){var t=this,e=t.$createElement;t._self._c},n=[];s.d(e,"a",function(){return i}),s.d(e,"b",function(){return n})},b544:function(t,e,s){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i=a(s("a7aa")),n=a(s("63eb")),o=a(s("0362"));s("71c2");function a(t){return t&&t.__esModule?t:{default:t}}var r=function(){return s.e("components/step/step").then(s.bind(null,"0e21"))},u=function(){return s.e("components/m-button").then(s.bind(null,"1460"))},c=function(){return s.e("components/twoButton/twoButton").then(s.bind(null,"a41a"))},p=function(){return Promise.all([s.e("common/vendor"),s.e("rattenking-dtpicker/rattenking-dtpicker")]).then(s.bind(null,"d6ea"))},h=function(){return Promise.all([s.e("common/vendor"),s.e("components/w-picker/w-picker")]).then(s.bind(null,"2ae5"))},l={data:function(){return{step:{value1:"第一步",value2:"第二步",value3:"第三步",value4:"第四步",active:"step-active",ago:"step-ago",kong:"",kong1:"",kong2:""},btn:{type:"primary",value:"下一步",disabled:!1,content:"上一步",commit:"提交",stepOne:!0,stepTwo:!1,stepThree:!1,stepFour:!1,Dates:!1,dates:!1},info:["上传身份证正面","上传身份证反面","上传授权委托书：","上传授权委托书："],tellinfo:["正面示例","反面示例","授权书示例"],num:0,count:0,src:i.default,ifday:!1,ifdays:!1,times:!0,timess:!0,idCardZ:"",idCardF:"",buyOil:"",takeOil:"",register:"",img:[],mode:"date",day:"2019-01-01",days:"2019-01-01"}},onLoad:function(){this.register=t.getStorageSync("register"),console.log(this.register," at pages\\register\\positive\\positive.vue:157")},methods:{all:function(){if(1==this.btn.stepOne){var e=this;t.chooseImage({count:1,success:function(t){e.count=1,console.log(t," at pages\\register\\positive\\positive.vue:168"),e.idCardZ=t.tempFilePaths,e.src=t.tempFiles[0].path,e.img.push({name:"id_fphoto",uri:t.tempFilePaths[0]})}})}else if(1==this.btn.stepTwo){var s=this;t.chooseImage({count:1,success:function(t){console.log(t.tempFiles," at pages\\register\\positive\\positive.vue:185"),s.count=2,s.idCardF=t.tempFilePaths,s.src=t.tempFiles[0].path,s.img.push({name:"id_bphoto",uri:t.tempFilePaths[0]})}})}else if(1==this.btn.stepThree){var i=this;t.chooseImage({count:1,success:function(t){console.log(t.tempFiles," at pages\\register\\positive\\positive.vue:200"),i.count=3,i.buyOil=t.tempFilePaths,i.src=t.tempFiles[0].path,i.img.push({name:"buy_auth_photo",uri:t.tempFilePaths[0]})}})}else if(1==this.btn.stepFour){var n=this;t.chooseImage({count:1,success:function(t){console.log(t.tempFiles," at pages\\register\\positive\\positive.vue:215"),n.count=4,n.takeOil=t.tempFilePaths,n.src=t.tempFiles[0].path,n.img.push({name:"get_auth_photo",uri:t.tempFilePaths[0]})}})}},oneSide:function(){if(console.log(this.register.role," at pages\\register\\positive\\positive.vue:232"),console.log(this.count," at pages\\register\\positive\\positive.vue:233"),1!=this.count)return t.showToast({title:"请上传身份证正面照",icon:"none"});this.btn.stepOne=!1,this.btn.stepTwo=!0,this.num=1,this.src=n.default,this.step.active="step-ago",this.step.kong="step-active"},lastStep:function(){this.btn.stepOne=!0,this.btn.stepTwo=!1,this.num=0,this.count-=1,this.src=i.default,this.step.active="step-active",this.step.kong=""},nextStep:function(){if(console.log(this.count," at pages\\register\\positive\\positive.vue:262"),2!=this.count)return t.showToast({title:"请上传身份证反面照",icon:"none"});this.btn.stepTwo=!1,this.btn.stepThree=!0,this.btn.Dates=!0,this.num=2,this.src=o.default,this.step.active="step-ago",this.step.kong="step-ago",this.step.kong1="step-active"},threeStepLast:function(){this.btn.stepThree=!1,this.btn.stepTwo=!0,this.btn.Dates=!1,this.num=1,this.count-=1,this.src=n.default,this.step.active="step-ago",this.step.kong="step-active",this.step.kong1=""},threeStepNext:function(){if(console.log(this.register.role," at pages\\register\\positive\\positive.vue:294"),console.log(this.count," at pages\\register\\positive\\positive.vue:295"),3!=this.count)return t.showToast({title:"请上传购油授权书",icon:"none"});if(1==this.ifday)this.btn.stepThree=!1,this.btn.stepFour=!0,this.btn.Dates=!1,this.btn.dates=!0,this.num=2,this.src=o.default,this.step.kong="step-ago",this.step.kong1="step-ago",this.step.kong2="step-active";else if(0==this.ifday)return t.showToast({title:"请选择授权有效期",icon:"none"})},fourStepLast:function(){this.btn.stepFour=!1,this.btn.stepThree=!0,this.btn.Dates=!0,this.btn.dates=!1,this.num=2,this.count-=1,this.src=o.default,this.step.kong="step-ago",this.step.kong1="step-active",this.step.kong2=""},fourStepNext:function(){var e=this.img.map(function(t,e){return{name:t.name,uri:t.uri}});if(4!=this.count)return t.showToast({title:"请上传提油授权书",icon:"none"});if(1==this.ifdays)t.uploadFile({url:"http://192.168.0.156:8080/api/bizcust/base/registCusmter",files:e,formData:{username:this.register.userPhoneNum,passwd:this.register.newPwd2,role:this.register.role,customer_id:this.register.companyId,manager_id:this.register.customerId,realname:this.register.userName,id_card:this.register.userId,phone:this.register.userPhoneNum,city:this.register.userCity,buy_auth_exp:this.day,get_auth_exp:this.days},success:function(e){var s=JSON.parse(e.data);console.log(s," at pages\\register\\positive\\positive.vue:366"),200==e.statusCode&&(10109==s.errorCode?(t.showToast({title:s.message}),t.removeStorage({key:"register"}),t.navigateTo({url:"../../login/login?val="+s.value})):t.showToast({title:s.message,icon:"none"}))}});else if(0==this.ifdays)return t.showToast({title:"请选择授权有效期",icon:"none"})},changeTimes:function(){this.times=!1,this.$refs.date.show()},changeTime:function(){this.timess=!1,this.$refs.date1.show()},onConfirm:function(t){console.log(t," at pages\\register\\positive\\positive.vue:412"),this.day=t.result,this.ifday=!0},onConfirms:function(t){this.days=t.result,this.ifdays=!0}},components:{step:r,mButton:u,tButton:c,ruiDatePicker:p,wPicker:h}};e.default=l}).call(this,s("6e42")["default"])},cd3b:function(t,e,s){}},[["e4b8","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/register/positive/positive1"],{"0044":function(e,t,i){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var s=a(i("a7aa")),n=a(i("63eb")),o=a(i("0362"));i("4676"),i("71c2");function a(e){return e&&e.__esModule?e:{default:e}}var r=function(){return i.e("components/step/step").then(i.bind(null,"0e21"))},u=function(){return i.e("components/m-button").then(i.bind(null,"1460"))},c=function(){return i.e("components/twoButton/twoButton").then(i.bind(null,"a41a"))},l=function(){return Promise.all([i.e("common/vendor"),i.e("rattenking-dtpicker/rattenking-dtpicker")]).then(i.bind(null,"d6ea"))},h=function(){return Promise.all([i.e("common/vendor"),i.e("components/w-picker/w-picker")]).then(i.bind(null,"2ae5"))},p={data:function(){return{step:{value1:"第一步",value2:"第二步",value3:"第三步",active:"step-active",ago:"step-ago",kong:"",kong1:""},btn:{type:"primary",value:"下一步",disabled:!1,content:"上一步",commit:"提交",stepOne:!0,stepTwo:!1,stepThree:!1},info:["上传身份证正面","上传身份证反面","上传授权委托书："],tellinfo:["正面示例","反面示例","授权书示例"],num:0,count:0,src:s.default,day:"2019-01-01",ifday:!1,times:!0,idCardZ:"",idCardF:"",buyOil:"",register:"",img:[],name:"",mode:"date"}},onLoad:function(t){this.register=e.getStorageSync("register"),this.name=t.name,console.log(this.register," at pages\\register\\positive\\positive1.vue:125")},methods:{all:function(){e.createCanvasContext("myCanvas");if(1==this.btn.stepOne){var t=this;e.chooseImage({count:1,sizeType:["compressed"],success:function(e){t.count=1,t.img.push({name:"id_fphoto",uri:e.tempFilePaths[0]}),t.src=e.tempFiles[0].path}})}else if(1==this.btn.stepTwo){var i=this;e.chooseImage({count:1,success:function(e){console.log(e.tempFiles," at pages\\register\\positive\\positive1.vue:149"),i.count=2,i.img.push({name:"id_bphoto",uri:e.tempFilePaths[0]}),i.src=e.tempFiles[0].path}})}else if(1==this.btn.stepThree){var s=this;e.chooseImage({count:1,success:function(e){s.count=3,s.img.push({name:"buy_auth_photo",uri:e.tempFilePaths[0]}),s.src=e.tempFiles[0].path}})}},oneSide:function(){this.btn.stepOne=!1,this.btn.stepTwo=!0,this.num=1,this.src=n.default,this.step.active="step-ago",this.step.kong="step-active"},lastStep:function(){this.btn.stepOne=!0,this.btn.stepTwo=!1,this.num=0,this.count-=1,this.src=s.default,this.active="step-active",this.kong=""},nextStep:function(){console.log(this.count," at pages\\register\\positive\\positive1.vue:200"),this.btn.stepTwo=!1,this.btn.stepThree=!0,this.btn.Dates=!0,this.num=2,this.src=o.default,this.step.active="step-ago",this.step.kong="step-ago",this.step.kong1="step-active"},threeStepLast:function(){this.btn.stepThree=!1,this.btn.stepTwo=!0,this.num=1,this.count-=1,this.src=n.default,this.step.active="step-ago",this.step.kong="step-active"},threeStepNext:function(){if("register"==this.name){console.log(this.register.role," at pages\\register\\positive\\positive1.vue:226");var t=this.img.map(function(e,t){return{name:e.name,uri:e.uri}});if(3!=this.count)return e.showToast({title:"请上传购油授权书",icon:"none"});if(1==this.ifday)e.uploadFile({url:"base/registCusmter",files:t,fileType:"image",filePath:"",name:"file",formData:{username:this.register.userPhoneNum,passwd:this.register.newPwd2,role:this.register.role,customer_id:this.register.companyId,manager_id:this.register.customerId,realname:this.register.userName,id_card:this.register.userId,phone:this.register.userPhoneNum,city:this.register.userCity,buy_auth_exp:this.day},success:function(t){200==t.statusCode&&0==t.data.errorCode&&(1==t.data.value?(e.removeStorage({key:"register"}),e.navigateTo({url:"../../login/login?val="+t.data.value})):e.uni.showToast({title:"用户已存在",icon:"none"}))}});else if(0==this.ifday)return console.log(this.ifday," at pages\\register\\positive\\positive1.vue:276"),e.showToast({title:"请选择授权有效期",icon:"none"})}else{console.log(this.register.role," at pages\\register\\positive\\positive1.vue:290");var i=this.img.map(function(e,t){return{name:e.name,uri:e.uri}});if(3!=this.count)return e.showToast({title:"请上传购油授权书",icon:"none"});if(1==this.ifday)e.uploadFile({url:"user/oil_authorize",files:i,fileType:"image",filePath:"",name:"file",formData:{role:2,buy_auth_exp:this.day},success:function(t){var i=JSON.parse(t.data);console.log(i," at pages\\register\\positive\\positive1.vue:313"),200==t.statusCode&&(10109==i.errorCode?(e.showToast({title:i.message}),e.removeStorage({key:"register"}),e.navigateTo({url:"../../login/login?val="+i.value})):e.showToast({title:i.message,icon:"none"}))}});else if(0==this.ifday)return console.log(this.ifday," at pages\\register\\positive\\positive1.vue:338"),e.showToast({title:"请选择授权有效期",icon:"none"})}},changeTimes:function(){this.times=!1,this.$refs.date.show()},onConfirm:function(e){this.day=e.result,this.ifday=!0}},components:{step:r,mButton:u,tButton:c,ruiDatePicker:l,wPicker:h}};t.default=p}).call(this,i("6e42")["default"])},"09f9":function(e,t,i){"use strict";i.r(t);var s=i("398b"),n=i("3dd8");for(var o in n)"default"!==o&&function(e){i.d(t,e,function(){return n[e]})}(o);i("1f45");var a=i("2877"),r=Object(a["a"])(n["default"],s["a"],s["b"],!1,null,null,null);t["default"]=r.exports},"1f45":function(e,t,i){"use strict";var s=i("ac64"),n=i.n(s);n.a},"398b":function(e,t,i){"use strict";var s=function(){var e=this,t=e.$createElement;e._self._c},n=[];i.d(t,"a",function(){return s}),i.d(t,"b",function(){return n})},"3dd8":function(e,t,i){"use strict";i.r(t);var s=i("0044"),n=i.n(s);for(var o in s)"default"!==o&&function(e){i.d(t,e,function(){return s[e]})}(o);t["default"]=n.a},ac64:function(e,t,i){}},[["4825","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/register/positive/positive2"],{"0a04":function(t,e,s){},"199a":function(t,e,s){"use strict";var i=s("0a04"),n=s.n(i);n.a},b5d7:function(t,e,s){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i=a(s("a7aa")),n=a(s("63eb")),o=a(s("0362"));s("71c2");function a(t){return t&&t.__esModule?t:{default:t}}var r=function(){return s.e("components/step/step").then(s.bind(null,"0e21"))},u=function(){return s.e("components/m-button").then(s.bind(null,"1460"))},c=function(){return s.e("components/twoButton/twoButton").then(s.bind(null,"a41a"))},p=function(){return Promise.all([s.e("common/vendor"),s.e("components/w-picker/w-picker")]).then(s.bind(null,"2ae5"))},l={data:function(){return{step:{value1:"第一步",value2:"第二步",value3:"第三步",active:"step-active",ago:"step-ago",kong:"",kong1:""},btn:{type:"primary",value:"下一步",disabled:!1,content:"上一步",commit:"提交",stepOne:!0,stepTwo:!1,stepThree:!1},info:["上传身份证正面","上传身份证反面","上传授权委托书："],tellinfo:["正面示例","反面示例","授权书示例"],num:0,count:0,src:i.default,days:"2019-01-01",ifdays:!1,times:!0,idCardZ:"",idCardF:"",takeOil:"",register:"",img:[],inputs:"",name:"",mode:"date"}},onLoad:function(e){this.register=t.getStorageSync("register"),console.log(this.register," at pages\\register\\positive\\positive2.vue:117"),this.name=e.name},methods:{all:function(){if(1==this.btn.stepOne){var e=this;t.chooseImage({count:1,success:function(t){e.count=1,console.log(t," at pages\\register\\positive\\positive2.vue:128"),e.img.push({name:"id_fphoto",uri:t.tempFilePaths[0]}),e.idCardZ=t.tempFilePaths,e.src=t.tempFiles[0].path}})}else if(1==this.btn.stepTwo){var s=this;t.chooseImage({count:1,success:function(t){console.log(t.tempFiles," at pages\\register\\positive\\positive2.vue:142"),s.count=2,s.img.push({name:"id_bphoto",uri:t.tempFilePaths[0]}),s.idCardF=t.tempFilePaths,s.src=t.tempFiles[0].path}})}else if(1==this.btn.stepThree){var i=this;t.chooseImage({count:1,success:function(t){console.log(t.tempFiles," at pages\\register\\positive\\positive2.vue:157"),i.count=3,i.img.push({name:"get_auth_photo",uri:t.tempFilePaths[0]}),i.buyOil=t.tempFilePaths,i.src=t.tempFiles[0].path}})}},oneSide:function(){if(console.log(this.register.role," at pages\\register\\positive\\positive2.vue:174"),1!=this.count)return t.showToast({title:"请上传身份证正面照",icon:"none"});this.btn.stepOne=!1,this.btn.stepTwo=!0,this.num=1,this.src=n.default,this.step.active="step-ago",this.step.kong="step-active"},lastStep:function(){this.btn.stepOne=!0,this.btn.stepTwo=!1,this.num=0,this.count-=1,this.src=i.default,this.active="step-active",this.kong=""},nextStep:function(){if(console.log(this.count," at pages\\register\\positive\\positive2.vue:203"),2!=this.count)return t.showToast({title:"请上传身份证反面照",icon:"none"});this.btn.stepTwo=!1,this.btn.stepThree=!0,this.btn.Dates=!0,this.num=2,this.src=o.default,this.step.active="step-ago",this.step.kong="step-ago",this.step.kong1="step-active"},threeStepLast:function(){this.btn.stepThree=!1,this.btn.stepTwo=!0,this.num=1,this.count-=1,this.src=n.default,this.step.active="step-ago",this.step.kong="step-active"},threeStepNext:function(){if("register"==this.name){var e=this.img.map(function(t,e){return{name:t.name,uri:t.uri}});if(console.log(e," at pages\\register\\positive\\positive2.vue:242"),3!=this.count)return t.showToast({title:"请上传购油授权书",icon:"none"});if(1==this.ifdays)t.uploadFile({url:"http://dev.pjy.name:8180/api/bizcust/base/registCusmter",files:e,formData:{username:this.register.userPhoneNum,passwd:this.register.newPwd2,role:this.register.role,customer_id:this.register.companyId,manager_id:this.register.customerId,realname:this.register.userName,id_card:this.register.userId,phone:this.register.userPhoneNum,city:this.register.userCity,get_auth_exp:this.days},success:function(e){var s=JSON.parse(e.data);console.log(s," at pages\\register\\positive\\positive2.vue:267"),200==e.statusCode&&(10109==s.errorCode?(t.showToast({title:s.message}),t.removeStorage({key:"register"}),t.navigateTo({url:"../../login/login?val="+s.value})):t.showToast({title:s.message,icon:"none"}))}});else if(0==this.ifdays)return t.showToast({title:"请选择授权有效期",icon:"none"})}else if("apply"==this.name){var s=this.img.map(function(t,e){return{name:t.name,uri:t.uri}});if(3!=this.count)return t.showToast({title:"请上传购油授权书",icon:"none"});if(1!=this.ifdays)return t.showToast({title:"请选择授权有效期",icon:"none"});console.log(1," at pages\\register\\positive\\positive2.vue:314"),t.uploadFile({url:"http://dev.pjy.name:8180/api/bizcust/user/oil_authorize",files:s,fileType:"image",formData:{role:2,buy_auth_exp:this.days},success:function(e){console.log(e," at pages\\register\\positive\\positive2.vue:324"),200==e.statusCode&&0==e.data.errorCode&&1==e.data.value&&t.showToast({title:"申请成功，待审批",icon:"none"})}})}},changeTimes:function(){this.times=!1,this.$refs.date.show()},onConfirm:function(t){this.days=t.result,this.ifdays=!0}},components:{step:r,mButton:u,tButton:c,wPicker:p}};e.default=l}).call(this,s("6e42")["default"])},cdc7:function(t,e,s){"use strict";s.r(e);var i=s("b5d7"),n=s.n(i);for(var o in i)"default"!==o&&function(t){s.d(e,t,function(){return i[t]})}(o);e["default"]=n.a},d4851:function(t,e,s){"use strict";var i=function(){var t=this,e=t.$createElement;t._self._c},n=[];s.d(e,"a",function(){return i}),s.d(e,"b",function(){return n})},f584:function(t,e,s){"use strict";s.r(e);var i=s("d4851"),n=s("cdc7");for(var o in n)"default"!==o&&function(t){s.d(e,t,function(){return n[t]})}(o);s("199a");var a=s("2877"),r=Object(a["a"])(n["default"],i["a"],i["b"],!1,null,null,null);e["default"]=r.exports}},[["d253","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/info/apply/apply"],{"17d9":function(t,e,n){},"19c9":function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o=function(){return n.e("components/m-info-text/m-info-text").then(n.bind(null,"1655"))},a={data:function(){return{buy:!0,take:!1,role:[]}},onLoad:function(){this.getJurisdiction()},methods:{getJurisdiction:function(){var t=this;this.test.post("user/query_user_role").then(function(e){console.log(e," at pages\\info\\apply\\apply.vue:51"),200==e.statusCode&&0==e.data.errorCode&&(t.role=e.data.value,2==t.role.length?(console.log(1," at pages\\info\\apply\\apply.vue:55"),t.buy=!0,t.take=!0):1==t.role.length&&(1==t.role[0].role_id?(console.log(2," at pages\\info\\apply\\apply.vue:60"),t.buy=!0,t.take=!1):2==t.role[0].role_id&&(console.log(3," at pages\\info\\apply\\apply.vue:64"),t.take=!0,t.buy=!1)))}).catch(function(t){console.log(t," at pages\\info\\apply\\apply.vue:71")})},GoBuyApply:function(){!0!==this.buy?t.navigateTo({url:"../../register/positive/positive1?name=apply"}):t.showToast({title:"您已有权限"})},GoTakeApply:function(){!0!==this.take?t.navigateTo({url:"../../register/positive/positive2?name=apply"}):t.showToast({title:"您已有权限"})}},components:{infoText:o}};e.default=a}).call(this,n("6e42")["default"])},9022:function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},a=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return a})},"98c6":function(t,e,n){"use strict";n.r(e);var o=n("19c9"),a=n.n(o);for(var i in o)"default"!==i&&function(t){n.d(e,t,function(){return o[t]})}(i);e["default"]=a.a},"9cf0":function(t,e,n){"use strict";n.r(e);var o=n("9022"),a=n("98c6");for(var i in a)"default"!==i&&function(t){n.d(e,t,function(){return a[t]})}(i);n("daa3");var u=n("2877"),l=Object(u["a"])(a["default"],o["a"],o["b"],!1,null,null,null);e["default"]=l.exports},daa3:function(t,e,n){"use strict";var o=n("17d9"),a=n.n(o);a.a}},[["4728","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/oilByCompany/oilByCompany"],{"1e04":function(t,a,e){"use strict";(function(t){Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var e={data:function(){return{datas:[],inputValue:"",page:1,pageSize:10,url:""}},methods:{chooseCompany:function(a){var e=this.datas[a].addr;t.setStorage({key:"company",data:e}),t.navigateTo({url:this.url})},searchCompany:function(){var a=this;""!==this.inputValue&&null!==this.inputValue?this.test.post("base/listCustCompany",{search:this.inputValue,page:this.page,pageSize:this.pageSize}).then(function(e){console.log(e," at pages\\oilByCompany\\oilByCompany.vue:55"),200==e.statusCode&&0==e.data.errorCode&&(a.datas=e.data.value,0===e.data.value.length&&t.showToast({title:"没有更多了",icon:"none"}))}).catch(function(t){console.log(t," at pages\\oilByCompany\\oilByCompany.vue:69")}):""==this.inputValue&&null==this.inputValue&&this.getCompanyInf()},getCompanyInfo:function(){var t=this;console.log(this.page,this.pageSize," at pages\\oilByCompany\\oilByCompany.vue:77"),this.test.post("base/listCustCompany",{search:"",page:this.page,pageSize:this.pageSize}).then(function(a){console.log(a," at pages\\oilByCompany\\oilByCompany.vue:83"),200==a.statusCode&&0==a.data.errorCode&&(t.datas=a.data.value)}).catch(function(t){console.log(t," at pages\\oilByCompany\\oilByCompany.vue:88")})},more:function(){this.page+=1,this.getCompanyInfo()}},onShow:function(){this.getCompanyInfo()},onLoad:function(t){this.url=t.address}};a.default=e}).call(this,e("6e42")["default"])},"21d5":function(t,a,e){"use strict";e.r(a);var n=e("fe11"),o=e("667a");for(var i in o)"default"!==i&&function(t){e.d(a,t,function(){return o[t]})}(i);e("beba");var u=e("2877"),s=Object(u["a"])(o["default"],n["a"],n["b"],!1,null,null,null);a["default"]=s.exports},"667a":function(t,a,e){"use strict";e.r(a);var n=e("1e04"),o=e.n(n);for(var i in n)"default"!==i&&function(t){e.d(a,t,function(){return n[t]})}(i);a["default"]=o.a},beba:function(t,a,e){"use strict";var n=e("d539"),o=e.n(n);o.a},d539:function(t,a,e){},fe11:function(t,a,e){"use strict";var n=function(){var t=this,a=t.$createElement;t._self._c},o=[];e.d(a,"a",function(){return n}),e.d(a,"b",function(){return o})}},[["77f4","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/orderList/orderList"],{2172:function(e,t,r){"use strict";var n=r("f9e8"),o=r.n(n);o.a},"499d":function(e,t,r){"use strict";r.r(t);var n=r("6f9c"),o=r("dd41");for(var a in o)"default"!==a&&function(e){r.d(t,e,function(){return o[e]})}(a);r("2172");var i=r("2877"),s=Object(i["a"])(o["default"],n["a"],n["b"],!1,null,null,null);t["default"]=s.exports},"6f9c":function(e,t,r){"use strict";var n=function(){var e=this,t=e.$createElement;e._self._c},o=[];r.d(t,"a",function(){return n}),r.d(t,"b",function(){return o})},"79ce":function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=function(){return r.e("common/js/xfl-select").then(r.bind(null,"d732"))},o={data:function(){return{list:[{value:"全部",label:0},{value:"已取消",label:-1},{value:"已完成 ",label:9},{value:"待付款",label:3},{value:"待开票",label:5},{value:"已确认价格",label:2},{value:"待确认收款",label:4}],orderNumber:"",buyTime:"",oilType:"",count:"",info:[],page:1,pageSize:10,status:0,showMore:!1,day:"",days:!1,time:""}},onLoad:function(e){this.day=e.times,this.orderNumber=e.ordernumber,this.getOrderListInfo()},methods:{getOrderListInfo:function(){var t=this,r=this;void 0!=this.day&&""!=this.day&&null!=this.day||(this.day=""),void 0!=this.orderNumber&&""!=this.orderNumber&&null!=this.orderNumber||(this.orderNumber=""),this.test.post("order/search_order",{start_time:this.day,end_time:this.day,status:this.status,order_sn:this.orderNumber,page:this.page,pageSize:this.pageSize}).then(function(n){if(console.log(n," at pages\\orderList\\orderList.vue:171"),200==n.statusCode&&0==n.data.errorCode){var o=n.data.value;t.info=o,t.info.forEach(function(e){t.time=new Date(e.create_time+288e5).toJSON().substr(0,16).replace("T"," ").replace(/-/g,"-")}),o.length>=10?t.showMore=!0:o.length<10&&o.length>0?t.showMore=!1:o.length<=0&&(t.showMore=!1,e.showToast({title:"没有数据了",icon:"none",success:function(){r.page=1,r.getOrderListInfo()}}))}}).catch(function(e){console.log(e," at pages\\orderList\\orderList.vue:196")})},orderDtails:function(t,r,n){1==t?e.showToast({title:"价格正在计算中,请稍等",icon:"none"}):e.navigateTo({url:"./orderDtails/orderDtails?id="+r+"&order_sn="+n+"&status="+t})},changeMsg:function(e){this.status=e.orignItem.label,this.page=1,this.getOrderListInfo()},more:function(){this.page+=1,this.getOrderListInfo()}},onNavigationBarButtonTap:function(t){e.navigateTo({url:"../search/search?name=orderList"})},components:{selects:n}};t.default=o}).call(this,r("6e42")["default"])},dd41:function(e,t,r){"use strict";r.r(t);var n=r("79ce"),o=r.n(n);for(var a in n)"default"!==a&&function(e){r.d(t,e,function(){return n[e]})}(a);t["default"]=o.a},f9e8:function(e,t,r){}},[["6f51","common/runtime","common/vendor"]]]);
});
require('pages/orderList/orderList.js');
__wxRoute = 'pages/search/search';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/search/search.js';

define('pages/search/search.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/search/search"],{"0b97":function(e,t,n){"use strict";n.r(t);var a=n("e679"),r=n.n(a);for(var o in a)"default"!==o&&function(e){n.d(t,e,function(){return a[e]})}(o);t["default"]=r.a},"45b0":function(e,t,n){},"4c5d":function(e,t,n){"use strict";var a=function(){var e=this,t=e.$createElement;e._self._c},r=[];n.d(t,"a",function(){return a}),n.d(t,"b",function(){return r})},9335:function(e,t,n){"use strict";var a=n("45b0"),r=n.n(a);r.a},db0c:function(e,t,n){"use strict";n.r(t);var a=n("4c5d"),r=n("0b97");for(var o in r)"default"!==o&&function(e){n.d(t,e,function(){return r[e]})}(o);n("9335");var s=n("2877"),i=Object(s["a"])(r["default"],a["a"],a["b"],!1,null,"3a2a2795",null);t["default"]=i.exports},e679:function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;n("71c2");var a=function(){return Promise.all([n.e("common/vendor"),n.e("rattenking-dtpicker/rattenking-dtpicker")]).then(n.bind(null,"d6ea"))},r=function(){return n.e("components/m-button").then(n.bind(null,"1460"))},o={data:function(){return{ordernumber:"",date:"请选择时间",values:"",btnType:"primary",btnValue:"查询",startDate:"2010-00-00",endDate:"2030-12-31",name:"",page:1,pageSize:10}},onLoad:function(e){this.name=e.name},methods:{bindChange:function(e){this.date=e.detail.value},search:function(){var t=this;"请选择时间"==this.date&&(this.date=""),"orderList"==this.name?this.test.post("order/search_order",{order_sn:this.ordernumber,start_time:this.date,end_time:this.date,page:this.page,pageSize:this.pageSize}).then(function(n){console.log(n," at pages\\search\\search.vue:65"),200==n.statusCode&&0==n.data.errorCode&&(n.data.value.length<=0?e.showToast({title:"搜索失败,订单编号无效或日期不正确",icon:"none"}):n.data.value.length>0&&e.navigateTo({url:"../orderList/orderList?times="+t.date+"&ordernumber="+t.ordernumber}))}).catch(function(e){console.log(e," at pages\\search\\search.vue:80")}):"reserveOilList"==this.name&&this.test.post("order/search_reserve",{reserve_sn:this.ordernumber,start_time:this.date,end_time:this.date,page:this.page,pageSize:this.pageSize}).then(function(n){console.log(n," at pages\\search\\search.vue:90"),200==n.statusCode&&0==n.data.errorCode&&(n.data.value.length<=0?e.showToast({title:"搜索失败,订单编号无效或日期不正确",icon:"none"}):n.data.value.length>0&&e.navigateTo({url:"../reserveOilList/reserveOilList?times="+t.date+"&ordernumber="+t.ordernumber}))}).catch(function(e){console.log(e," at pages\\search\\search.vue:105")})}},components:{ruiDatePicker:a,mButton:r}};t.default=o}).call(this,n("6e42")["default"])}},[["4606","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/orderList/orderDtails/orderDtails"],{"14a3":function(t,e,o){"use strict";o.r(e);var r=o("582f"),n=o("fad3");for(var i in n)"default"!==i&&function(t){o.d(e,t,function(){return n[t]})}(i);o("ebf6");var s=o("2877"),a=Object(s["a"])(n["default"],r["a"],r["b"],!1,null,null,null);e["default"]=a.exports},"582f":function(t,e,o){"use strict";var r=function(){var t=this,e=t.$createElement;t._self._c},n=[];o.d(e,"a",function(){return r}),o.d(e,"b",function(){return n})},"5a58":function(t,e,o){},"9f7d":function(t,e,o){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var r=o("71c2"),n=function(){return o.e("components/twoButton/twoButton").then(o.bind(null,"a41a"))},i=function(){return o.e("components/m-button").then(o.bind(null,"1460"))},s={data:function(){return{type1:"defult",type:"primary",con1:"取消订单",con2:"确认购买",btnValue:"确认已付款",closed:"关闭",dates:"2019-08-12 08:12",rotate:!1,orderId:"",order_sn:"",order:[],time:"",countDown:"00:00:00",disabled:!1,have:"",status:"",delivery:"100"}},onLoad:function(t){this.orderId=t.id,this.status=t.status,this.order_sn=t.order_sn,this.getOrderDtails(),-2==this.status||-1==this.status||9==this.status||5==this.status?this.have=!0:this.have=!1},methods:{getOrderDtails:function(){var t=this;this.test.post("order/query_OrderById",{id:this.orderId}).then(function(e){if(console.log(e," at pages\\orderList\\orderDtails\\orderDtails.vue:174"),200==e.statusCode&&0==e.data.errorCode){t.order=e.data.value,t.time=new Date(t.order.create_time+288e5).toJSON().substr(0,16).replace("T"," ").replace(/-/g,"-");var o=t.order.difference;t.cutDown(o)}}).catch(function(t){console.log(t," at pages\\orderList\\orderDtails\\orderDtails.vue:183")})},cutDown:function(t){var e=this;0==t&&clearInterval(),setInterval(function(){t--,e.countDown=(0,r.formatSeconds)(t)},1e3)},sureBuy:function(e){t.navigateTo({url:"../invoice/invoice?id="+this.orderId+"&number="+e+"&order_sn="+this.order_sn+"&status="+this.status+"&company="+this.order.org_name+"&moeny="+this.oilPrice})},tell:function(){this.disabled=!this.disabled,t.showToast({title:"已提醒财务确认,请耐心等待",icon:"none"})},cancelOrder:function(){var e=this;t.showModal({content:"确认取消订单",success:function(o){o.confirm?e.test.post("order/cancel_order",{id:e.orderId}).then(function(e){200==e.statusCode&&0==e.data.errorCode?(t.redirectTo({url:"../orderList"}),t.showToast({title:"取消订单成功"})):t.showToast({title:"取消订单失败",icon:"none"})}).catch(function(t){console.log(t," at pages\\orderList\\orderDtails\\orderDtails.vue:232")}):o.cancel}})},closePage:function(){t.navigateBack({delta:1})},goRotate:function(){this.rotate=!this.rotate}},computed:{oilPrice:function(){return parseFloat(this.order.oil_price*this.order.count).toFixed(2)},orderPrice:function(){return(parseFloat(this.oilPrice)+parseFloat(this.delivery)).toFixed(2)}},components:{tButton:n,mButton:i}};e.default=s}).call(this,o("6e42")["default"])},ebf6:function(t,e,o){"use strict";var r=o("5a58"),n=o.n(r);n.a},fad3:function(t,e,o){"use strict";o.r(e);var r=o("9f7d"),n=o.n(r);for(var i in r)"default"!==i&&function(t){o.d(e,t,function(){return r[t]})}(i);e["default"]=n.a}},[["448b","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/orderList/invoice/invoice"],{"1c01":function(i,t,e){},"31ef":function(i,t,e){"use strict";var n=e("1c01"),o=e.n(n);o.a},b7f3:function(i,t,e){"use strict";var n=function(){var i=this,t=i.$createElement;i._self._c},o=[];e.d(t,"a",function(){return n}),e.d(t,"b",function(){return o})},c766:function(i,t,e){"use strict";e.r(t);var n=e("b7f3"),o=e("f546");for(var s in o)"default"!==s&&function(i){e.d(t,i,function(){return o[i]})}(s);e("31ef");var c=e("2877"),r=Object(c["a"])(o["default"],n["a"],n["b"],!1,null,null,null);t["default"]=r.exports},eb42:function(i,t,e){"use strict";(function(i){function n(i,t,e){return t in i?Object.defineProperty(i,t,{value:e,enumerable:!0,configurable:!0,writable:!0}):i[t]=e,i}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=function(){return e.e("components/twoButton/twoButton").then(e.bind(null,"a41a"))},s=function(){return e.e("components/m-info-img/m-info-img").then(e.bind(null,"8eb7"))},c=function(){return e.e("components/m-info-text/m-info-text").then(e.bind(null,"1655"))},r={data:function(){var i;return{btn:{type:"primary",con2:"确认",dsiabled:!1},invoice:(i={company:"xxxxxxxx公司",disabled:!0,moeny:"111111111",placeholder:"22222222"},n(i,"company","开票公司"),n(i,"moeny","开票金额"),n(i,"types","发票类型"),n(i,"way","拆分方式"),n(i,"currentOil","当前购油量"),n(i,"surplus","剩余未拆油量"),i),list:[],ids:-1,typeInvoice:"请选择发票类型",invoiceTypes:!1,id:"",invoiceNum:[],show:!1,value:!1,num:"",currentOil:"",move:!1,order_sn:"",company:"",status:"",moeny:""}},onLoad:function(i){this.id=i.id,this.currentOil=i.number,this.order_sn=i.order_sn,this.company=i.company,this.status=i.status,this.moeny=i.moeny},methods:{chooseInvoice:function(){this.invoiceTypes=!this.invoiceTypes},invoiceType:function(i){console.log(i," at pages\\orderList\\invoice\\invoice.vue:126"),this.typeInvoice=i.target.id,this.invoiceTypes=!this.invoiceTypes},chooseUsersShow:function(){this.invoiceTypes=!this.invoiceTypes},showIncoice:function(i){i.target.value?this.ids=1:this.ids=-1,this.show=!this.show},add:function(){this.list.push({nums:""})},detal:function(i){this.list.splice(i,1)},cancelOrder:function(){var t=this;this.test.post("order/make_invoice",{id:this.id,is_invoice:this.ids}).then(function(e){console.log(e," at pages\\orderList\\invoice\\invoice.vue:159"),200==e.statusCode&&0==e.data.errorCode&&i.redirectTo({url:"../orderDtails/orderDtails?id="+t.id+"&order_sn="+t.order_sn+"&status="+t.status})}).catch(function(i){console.log(i," at pages\\orderList\\invoice\\invoice.vue:166")})},invoiceSure:function(t){var e=this;if("请选择发票类型"==this.typeInvoice)i.showToast({title:"请选择发票类型",icon:"none"});else{this.invoiceNum=[];var n=this;0==this.list.length?(this.invoiceNum.push(this.num),this.invoiceNum=String(this.invoiceNum)):(this.invoiceNum.push(this.num),this.list.forEach(function(i){console.log(i," at pages\\orderList\\invoice\\invoice.vue:186"),n.invoiceNum.push(i.nums)}),this.invoiceNum=String(this.invoiceNum)),console.log(this.invoiceNum," at pages\\orderList\\invoice\\invoice.vue:193"),1==this.ids?""!==this.invoiceNum?0==this.surplusOil?this.test.post("order/make_invoice",{id:this.id,invoice_type:this.typeInvoice,is_invoice:this.ids,invoice_split:this.invoiceNum}).then(function(t){console.log(t," at pages\\orderList\\invoice\\invoice.vue:203"),200==t.statusCode&&0==t.data.errorCode&&(i.showToast({title:"开票成功"}),i.redirectTo({url:"../orderDtails/orderDtails?id="+e.id+"&order_sn="+e.order_sn+"&status="+e.status}))}).catch(function(i){console.log(i," at pages\\orderList\\invoice\\invoice.vue:213")}):i.showToast({title:"发票拆分数量必须与当前油量一致",icon:"none"}):i.showToast({title:"请填写拆分数量",icon:"none"}):-1==this.ids&&this.test.post("order/make_invoice",{id:this.id,invoice_type:this.typeInvoice,is_invoice:this.ids,invoice_split:this.currentOil}).then(function(t){console.log(t," at pages\\orderList\\invoice\\invoice.vue:236"),200==t.statusCode&&0==t.data.errorCode&&(i.showToast({title:"开票成功"}),i.redirectTo({url:"../orderDtails/orderDtails?id="+e.id+"&order_sn="+e.order_sn+"&status="+e.status}))}).catch(function(i){console.log(i," at pages\\orderList\\invoice\\invoice.vue:246")})}}},components:{tButton:o,infoImg:s,infoText:c},watch:{surplusOil:function(t,e){console.log(t,e," at pages\\orderList\\invoice\\invoice.vue:261"),t<0?(this.btn.disabled=!0,i.showToast({title:"输入的数字不能超过总吨数",icon:"none"})):this.btn.disabled=!1}},computed:{surplusOil:function(){if(0===this.list.length)return parseFloat(this.currentOil-this.num);for(var i=parseFloat(this.currentOil-this.num),t=0;t<this.list.length;t++)i-=this.list[t].nums;return i}}};t.default=r}).call(this,e("6e42")["default"])},f546:function(i,t,e){"use strict";e.r(t);var n=e("eb42"),o=e.n(n);for(var s in n)"default"!==s&&function(i){e.d(t,i,function(){return n[i]})}(s);t["default"]=o.a}},[["9dd4","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/reserveOil/reserveOil"],{"010fd":function(e,t,r){"use strict";r.r(t);var o=r("7b5c"),i=r("de1b");for(var s in i)"default"!==s&&function(e){r.d(t,e,function(){return i[e]})}(s);r("a928");var n=r("2877"),u=Object(n["a"])(i["default"],o["a"],o["b"],!1,null,null,null);t["default"]=u.exports},"322b":function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=r("71c2"),i=function(){return Promise.all([r.e("common/vendor"),r.e("rattenking-dtpicker/rattenking-dtpicker")]).then(r.bind(null,"d6ea"))},s=function(){return r.e("components/m-info-text/m-info-text").then(r.bind(null,"1655"))},n=function(){return r.e("components/m-info-img/m-info-img").then(r.bind(null,"8eb7"))},u=function(){return r.e("components/m-button").then(r.bind(null,"1460"))},l={data:function(){return{text:{orderNumberText:"订单编号",dayTimeText:"提油时间",productOilText:"提油油品",modeOilText:"提油方式",muchOilText:"提油数量",disabled:!0,orderNumberP:"选择订单编号",dayP:"请选择时间",productOilP:"选择提油油品",modeOilP:"选择提油方式"},chooseNumber:{page:1,pageSize:10,orderInfo:[]},values:{orderNumber:"",productOil:"",modeOil:"",muchOil:""},address:"",startDate:new Date,url:"reserveOil",primary:"primary",btnValue:"提交",day:(0,o.formatDateMin)(new Date),showOrderNumber:!1,muchOilText:"",remark:"",id:"",more:!0,showAddress:!0}},onLoad:function(){this.getorderNumberInfo()},methods:{getorderNumberInfo:function(){var t=this;this.test.post("order/query_orderSnInfo",{page:this.chooseNumber.page,pageSize:this.chooseNumber.pageSize}).then(function(r){console.log(r," at pages\\reserveOil\\reserveOil.vue:145"),200==r.statusCode&&0==r.data.errorCode&&(t.chooseNumber.orderInfo=r.data.value,r.data.value.length<10&&r.data.value.length>0?t.more=!1:0==r.data.value.length&&(t.more=!1,e.showToast({title:"没有更多了",icon:"none"})))}).catch(function(e){console.log(e," at pages\\reserveOil\\reserveOil.vue:159")})},bindChange:function(e){console.log(e," at pages\\reserveOil\\reserveOil.vue:164")},goOrderNumber:function(){this.showOrderNumber=!this.showOrderNumber},chooseNumbers:function(e,t){console.log(e," at pages\\reserveOil\\reserveOil.vue:184"),this.id=t,this.values.orderNumber=this.chooseNumber.orderInfo[e].order_sn,this.values.productOil=this.chooseNumber.orderInfo[e].oil_type,0==this.chooseNumber.orderInfo[e].get_type?this.values.modeOil="配送":this.values.modeOil="自提",""==this.values.modeOil||"配送"==this.values.modeOil?this.showAddress=!0:"自提"==this.values.modeOil&&(this.showAddress=!1),this.muchOilText=this.chooseNumber.orderInfo[e].oil_remain,this.address=this.chooseNumber.orderInfo[e].ship_addr,this.showOrderNumber=!this.showOrderNumber},allIn:function(){""==this.values.orderNumber||null==this.values.orderNumber?e.showToast({title:"请选择订单编号",icon:"none"}):this.values.muchOil=this.muchOilText},getOilNum:function(t){console.log(t.detail.value," at pages\\reserveOil\\reserveOil.vue:215"),""==this.values.orderNumber||null==this.values.orderNumber?e.showToast({title:"请选择订单编号",icon:"none"}):t.detail.value>this.muchOilText&&e.showToast({title:"不能超过油的总量："+this.muchOilText,icon:"none"})},Smore:function(){this.chooseNumber.page+=1,this.getorderNumberInfo()},commit:function(t){var r=Number(this.values.muchOil),o=this.day;console.log(o," at pages\\reserveOil\\reserveOil.vue:238"),""!==this.values.orderNumber&&null!==this.values.orderNumber?""!==this.values.muchOil&&null!==this.values.muchOil?(console.log(typeof r,typeof this.id," at pages\\reserveOil\\reserveOil.vue:241"),this.test.post("order/mark_reserve",{bz_order_id:this.id,reserve_time:o,extract_num:r,remark:this.remark}).then(function(t){console.log(t," at pages\\reserveOil\\reserveOil.vue:248"),200==t.statusCode&&0==t.data.errorCode&&e.navigateTo({url:"../reserveOilList/reserveOilList"})}).catch(function(e){console.log(e," at pages\\reserveOil\\reserveOil.vue:255")})):e.showToast({title:"请输入提油数量",icon:"none"}):e.showToast({title:"请选择订单编号",icon:"none"})}},components:{infoImg:n,infoText:s,mButton:u,ruiDatePicker:i}};t.default=l}).call(this,r("6e42")["default"])},"53b4":function(e,t,r){},"7b5c":function(e,t,r){"use strict";var o=function(){var e=this,t=e.$createElement,o=(e._self._c,r("79f9"));e.$mp.data=Object.assign({},{$root:{m0:o}})},i=[];r.d(t,"a",function(){return o}),r.d(t,"b",function(){return i})},a928:function(e,t,r){"use strict";var o=r("53b4"),i=r.n(o);i.a},de1b:function(e,t,r){"use strict";r.r(t);var o=r("322b"),i=r.n(o);for(var s in o)"default"!==s&&function(e){r.d(t,e,function(){return o[e]})}(s);t["default"]=i.a}},[["d39c","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/reserveOilList/reserveOilList"],{"132c":function(e,t,s){"use strict";s.r(t);var n=s("37b8"),i=s.n(n);for(var r in n)"default"!==r&&function(e){s.d(t,e,function(){return n[e]})}(r);t["default"]=i.a},"1fc3":function(e,t,s){"use strict";var n=s("e9e5"),i=s.n(n);i.a},"37b8":function(e,t,s){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=function(){return s.e("common/js/xfl-select").then(s.bind(null,"d732"))},i={data:function(){return{list:[{value:"全部",label:0},{value:"已拒绝",label:-1},{value:"已发油",label:5},{value:"已完成",label:9},{value:"预约已确定",label:4},{value:"等待预约确定",label:1}],page:1,pageSize:10,oil:[],more:!0,status:"",time:"",day:"",reserve_sn:""}},onLoad:function(e){this.reserve_sn=e.ordernumber,this.day=e.times,this.getReserveList(this.reserve_sn)},methods:{getReserveList:function(){var t=this;void 0!=this.day&&""!=this.day&&null!=this.day||(this.day=""),void 0!=this.reserve_sn&&""!=this.reserve_sn&&null!=this.reserve_sn||(this.reserve_sn=""),this.test.post("order/search_reserve",{reserve_sn:this.reserve_sn,status:this.status,start_time:this.day,end_time:this.day,page:this.page,pageSize:this.pageSize}).then(function(s){console.log(s," at pages\\reserveOilList\\reserveOilList.vue:120"),200==s.statusCode&&0==s.data.errorCode&&(t.oil=s.data.value,t.oil.forEach(function(e){t.time=e.reserve_time,t.time=new Date(t.time+288e5).toJSON().substr(0,16).replace("T"," ").replace(/-/g,"-")}),s.data.value.length<10&&s.data.value.length>0?t.more=!1:0==s.data.value.length&&(t.more=!1,e.showToast({title:"没有更多了",icon:"none"})))}).catch(function(e){console.log(e," at pages\\reserveOilList\\reserveOilList.vue:138")})},reserveList:function(t,s){e.navigateTo({url:"confirmed/confirmed?reserve_id="+t+"&reserve_sn="+s})},complete:function(){},changeMsg:function(e){this.page=1,this.status=e.orignItem.label,this.getReserveList()},Smore:function(){this.page+=1,this.getReserveList()}},onNavigationBarButtonTap:function(t){e.navigateTo({url:"../search/search?name=reserveOilList"})},components:{selects:n}};t.default=i}).call(this,s("6e42")["default"])},"96cb":function(e,t,s){"use strict";s.r(t);var n=s("fe20"),i=s("132c");for(var r in i)"default"!==r&&function(e){s.d(t,e,function(){return i[e]})}(r);s("1fc3");var a=s("2877"),o=Object(a["a"])(i["default"],n["a"],n["b"],!1,null,null,null);t["default"]=o.exports},e9e5:function(e,t,s){},fe20:function(e,t,s){"use strict";var n=function(){var e=this,t=e.$createElement,n=(e._self._c,s("79f9"));e.$mp.data=Object.assign({},{$root:{m0:n}})},i=[];s.d(t,"a",function(){return n}),s.d(t,"b",function(){return i})}},[["19b1","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/reserveOilList/confirmed/confirmed"],{"1a12":function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=function(){return n.e("components/step/step").then(n.bind(null,"0e21"))},s=function(){return n.e("components/m-info-text/m-info-text").then(n.bind(null,"1655"))},o=function(){return n.e("components/m-button").then(n.bind(null,"1460"))},i={data:function(){return{step:{value1:"待确认",value2:"待发油",value3:"待收油",value4:"已拒绝",value5:"已完成",waitSure:"",waitSend:"",waitGet:"",refuse:"step-wait",complete:"step-ago"},confirmed:{order:"预约单号",time:"预约时间",company:"提油单位",oil:"油品类型",much:"提油数量(吨)",main:"提油方式"},btn:{type:"primary",value:"关闭"},disabled:!0,address:"",order:"",company:"",oil:"",much:"",main:"",status:"",right:!0,rId:"",oId:"",reserveInfo:"",showAddress:!1,time:""}},onLoad:function(e){this.rId=e.reserve_id,this.oId=e.reserve_sn,this.getReserveOilList()},methods:{getReserveOilList:function(){var e=this;this.test.post("order/query_reserve_info",{reserve_id:this.rId,reserve_sn:this.oId}).then(function(t){console.log(t," at pages\\reserveOilList\\confirmed\\confirmed.vue:109"),200==t.statusCode&&0==t.data.errorCode&&(e.reserveInfo=t.data.value,e.status=e.reserveInfo.status,e.time=new Date(e.reserveInfo.reserve_time+288e5).toJSON().substr(0,16).replace("T"," ").replace(/-/g,"-"),e.order=e.reserveInfo.reserve_sn,e.much=String(e.reserveInfo.extract_num),e.address=e.reserveInfo.ship_addr,e.company=e.reserveInfo.org_name,e.oil=e.reserveInfo.oil_type,0==e.reserveInfo.get_type?e.main="配送":e.main="自提","配送"==e.main?e.showAddress=!0:e.showAddress=!1,1==e.status?(e.step.waitSure="step-active",e.step.waitSend="",e.step.waitGet=""):2==e.status||4==e.status?(e.step.waitSure="step-ago",e.step.waitSend="step-active",e.step.waitGet=""):3!=e.status&&5!=e.status||(e.step.waitSure="step-ago",e.step.waitSend="step-ago",e.step.waitGet="step-active"))}).catch(function(e){console.log(e," at pages\\reserveOilList\\confirmed\\confirmed.vue:150")})},close:function(){e.navigateBack({delta:1})},back:function(){e.redirectTo({url:"../reserveOilList"})},getCode:function(){e.navigateTo({url:"oliCode/oliCode?id="+this.rId+"&reserve_sn="+this.oId})}},components:{step:r,infoText:s,mButton:o}};t.default=i}).call(this,n("6e42")["default"])},"420b":function(e,t,n){"use strict";var r=n("af28"),s=n.n(r);s.a},"786c":function(e,t,n){"use strict";n.r(t);var r=n("1a12"),s=n.n(r);for(var o in r)"default"!==o&&function(e){n.d(t,e,function(){return r[e]})}(o);t["default"]=s.a},8177:function(e,t,n){"use strict";var r=function(){var e=this,t=e.$createElement;e._self._c},s=[];n.d(t,"a",function(){return r}),n.d(t,"b",function(){return s})},8906:function(e,t,n){"use strict";n.r(t);var r=n("8177"),s=n("786c");for(var o in s)"default"!==o&&function(e){n.d(t,e,function(){return s[e]})}(o);n("420b");var i=n("2877"),a=Object(i["a"])(s["default"],r["a"],r["b"],!1,null,null,null);t["default"]=a.exports},af28:function(e,t,n){}},[["9929","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/reserveOilList/confirmed/oliCode/oliCode"],{"36fa":function(e,t,n){"use strict";var o=n("4cef"),i=n.n(o);i.a},"4cef":function(e,t,n){},"5caa":function(e,t,n){"use strict";n.r(t);var o=n("7b2c"),i=n("c1b9");for(var c in i)"default"!==c&&function(e){n.d(t,e,function(){return i[e]})}(c);n("36fa");var r=n("2877"),s=Object(r["a"])(i["default"],o["a"],o["b"],!1,null,null,null);t["default"]=s.exports},"7b2c":function(e,t,n){"use strict";var o=function(){var e=this,t=e.$createElement;e._self._c},i=[];n.d(t,"a",function(){return o}),n.d(t,"b",function(){return i})},"9d49":function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=function(){return n.e("components/m-button").then(n.bind(null,"1460"))},i=function(){return Promise.all([n.e("common/vendor"),n.e("components/tki-qrcode/tki-qrcode")]).then(n.bind(null,"8e80"))},c={data:function(){return{value:!1,options:[{value:1,label:"我同意"}],checkes:!0,checked:!1,ifShow:!0,val:"",size:550,unit:"upx",background:"#b4e9e2",foreground:"#309286",pdground:"#32dbc6",icon:"",iconsize:40,lv:3,onval:!0,loadMake:!0,src:"",id:"",reserve_sn:"",otherNumber:""}},onLoad:function(e){this.id=e.id,this.reserve_sn=e.reserve_sn,this.getCode()},methods:{getCode:function(){var e=this;this.test.post("order/reserve_encrypt",{id:this.id,reserve_sn:this.reserve_sn}).then(function(t){console.log(t," at pages\\reserveOilList\\confirmed\\oliCode\\oliCode.vue:74"),200==t.statusCode&&0==t.data.errorCode&&(e.val=t.data.value)}).catch(function(e){console.log(e," at pages\\reserveOilList\\confirmed\\oliCode\\oliCode.vue:79")})},cancel:function(){this.checked=!this.checked,this.checkes=!this.checkes},qrR:function(e){this.src=e},send:function(){return""===this.otherNumber?e.showToast({title:"请填写手机号码",icon:"none"}):1==this.checkes?e.showToast({title:"请阅读免责条款,勾选后方可发送",icon:"none"}):void e.showToast({title:"发送成功"})}},components:{mButton:o,tkiQrcode:i}};t.default=c}).call(this,n("6e42")["default"])},c1b9:function(e,t,n){"use strict";n.r(t);var o=n("9d49"),i=n.n(o);for(var c in o)"default"!==c&&function(e){n.d(t,e,function(){return o[e]})}(c);t["default"]=i.a}},[["0fa5","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/info/stayOil/stayOil"],{"9cc0":function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=n("2f62");function r(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{},o=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(o=o.concat(Object.getOwnPropertySymbols(n).filter(function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable}))),o.forEach(function(t){a(e,t,n[t])})}return e}function a(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var i={data:function(){return{ordernumber:"2132134564646",type:"95#乙醇汽油",mode:"配送",title:"选择单号",url:"",page:1,pageSize:10,orderInfo:[],more:!0}},methods:{getorderNumberInfo:function(){var t=this;this.test.post("order/query_orderSnInfo",{page:this.page,pageSize:this.pageSize}).then(function(n){console.log(n," at pages\\info\\stayOil\\stayOil.vue:49"),200==n.statusCode&&0==n.data.errorCode&&(t.orderInfo=n.data.value,n.data.value.length<10&&n.data.value.length>0?t.more=!1:0==n.data.value.length&&(t.more=!1,e.showToast({title:"没有更多了",icon:"none"})))}).catch(function(e){console.log(e," at pages\\info\\stayOil\\stayOil.vue:63")})},getOrderNumber:function(){2==this.role||3==this.role?e.navigateTo({url:"../../reserveOilList/confirmed/oliCode/oliCode"}):e.showToast({title:"权限不够，请在用户信息界面申请权限",icon:"none"})},Smore:function(){this.page+=1,this.getorderNumberInfo()}},onLoad:function(e){this.url=e.url,this.getorderNumberInfo()},computed:r({},(0,o.mapState)(["role"]))};t.default=i}).call(this,n("6e42")["default"])},a3a8:function(e,t,n){"use strict";n.r(t);var o=n("f23b"),r=n("ad0f");for(var a in r)"default"!==a&&function(e){n.d(t,e,function(){return r[e]})}(a);var i=n("2877"),u=Object(i["a"])(r["default"],o["a"],o["b"],!1,null,null,null);t["default"]=u.exports},ad0f:function(e,t,n){"use strict";n.r(t);var o=n("9cc0"),r=n.n(o);for(var a in o)"default"!==a&&function(e){n.d(t,e,function(){return o[e]})}(a);t["default"]=r.a},f23b:function(e,t,n){"use strict";var o=function(){var e=this,t=e.$createElement,o=(e._self._c,n("79f9"));e.$mp.data=Object.assign({},{$root:{m0:o}})},r=[];n.d(t,"a",function(){return o}),n.d(t,"b",function(){return r})}},[["dd1d","common/runtime","common/vendor"]]]);
});
